...
*/}}
{{- define "zeppelin.ingress.apiVersion" -}}
{{- if semverCompare "<1.14-0" (include "zeppelin.kubeVersion" .) -}}
{{- print "extensions/v1beta1" -}}
{{- else if semverCompare "<1.19-0" (include "zeppelin.kubeVersion" .) -}}
